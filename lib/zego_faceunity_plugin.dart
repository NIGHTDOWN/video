...
class ZegoFaceunityPlugin {
  ...
  Future<void> setCustomVideoCaptureSource(
      ZegoCustomSourceType sourceType) async {
    return await _channel.invokeMethod(
        'setCustomVideoCaptureSource', {'sourceType': sourceType.index});
  }
